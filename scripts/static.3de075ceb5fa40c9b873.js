...
/******/ 	__webpack_require__.p = "/test-react/";
/******/
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _server = __webpack_require__(158);
	
	var _server2 = _interopRequireDefault(_server);
	
	var _history = __webpack_require__(159);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement('base', { href: this.props.baseHref }),
	          _react2.default.createElement(
	            'title',
	            null,
	            'Test d\'intégration'
	          ),
	          _react2.default.createElement('link', { rel: 'shortcut icon', href: __webpack_require__(234) }),
	          _react2.default.createElement('meta', { name: 'keywords', content: '1000volts, lorem, ipsum' }),
	          _react2.default.createElement('meta', { name: 'description', content: 'Lorem ipsum dolor sit amet' }),
	          _react2.default.createElement('meta', { name: 'geo.placename', content: 'Le Rheu, Bretagne, France' }),
	          _react2.default.createElement('meta', { name: 'twitter:site', content: '@1000_Volts' }),
	          this.props.stylesheets.map(function (stylesheet) {
	            return _react2.default.createElement('link', { rel: 'stylesheet', href: stylesheet });
	          })
	        ),
	        _react2.default.createElement(
	          'body',
	          null,
	          _react2.default.createElement('div', { id: 'app', dangerouslySetInnerHTML: { __html: this.props.appHtml } }),
	          this.props.scripts.map(function (script) {
	            return _react2.default.createElement('script', { src: script });
	          })
	        )
	      );
	    }
	...
	Page.propTypes = {
	  scripts: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.string).isRequired,
	  stylesheets: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.string).isRequired,
	  appHtml: _react2.default.PropTypes.string.isRequired,
	  baseHref: _react2.default.PropTypes.string.isRequired
	};
	
	module.exports = function render(locals, callback) {
	  var props = {
	    scripts: [locals.assets.web],
	    stylesheets: [],
	    baseHref: locals.webpackStats.compilation.outputOptions.publicPath
	  };
	  Object.keys(locals.webpackStats.compilation.assets).forEach(function (asset) {
	    if (/\.css$/.test(asset)) {
	      props.stylesheets.push(asset);
	    }
	  });
	
	  var history = (0, _history.useBasename)(_history.createMemoryHistory)({
	    basename: props.baseHref
	  });
	  var location = history.createLocation(props.baseHref + locals.path);
	
	  (0, _reactRouter.match)({ routes: _routes2.default, location: location, basename: props.baseHref }, function (error, redirectLocation, renderProps) {
	    console.log('ertrt', history.createHref('/'));
	    console.log('huhu', renderProps.history.createHref('/'));
	    //renderProps.history = history;
	    //console.log('ahah', renderProps.history.createHref('/'));
	    // Application element that will be overriden on client
	    console.log(renderProps);
	    props.appHtml = _server2.default.renderToString(_react2.default.createElement(_reactRouter.RoutingContext, renderProps));
	
	    var html = _server2.default.renderToStaticMarkup(_react2.default.createElement(Page, props));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Page3 = __webpack_require__(232);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NavToggle = __webpack_require__(216);
	...
	var Header = (function (_React$Component) {
	  ...
	  _createClass(Header, [{
	    key: 'render',
	    value: function render() {
	      var navBarClasses = this.state.navOpened ? 'opened' : '';
	
	      return _react2.default.createElement(
	        'header',
	        { id: 'header' },
	        _react2.default.createElement(_NavToggle2.default, { onToggleNav: this._toggleNav }),
	        _react2.default.createElement(
	          'nav',
	          { id: 'header-nav', className: navBarClasses },
	          _react2.default.createElement(
	            'ul',
	            null,
	            _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                _reactRouter.Link,
	                { to: '/page1', activeClassName: 'active' },
	                'Page 1'
	              )
	            ),
	            _react2.default.createElement(
	              ...
	              _react2.default.createElement(
	                _reactRouter.Link,
	                { to: '/page2', activeClassName: 'active' },
	                'Page 2'
	              )
	            ),
	            _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavToggle = (function (_React$Component) {
	  ...
	  _createClass(NavToggle, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        "button",
	        { id: "header-nav-toggle", type: "button", onClick: this.props.onToggleNav },
	...
	NavToggle.propTypes = {
	  onToggleNav: _react2.default.PropTypes.func.isRequired
	};
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'span',
	          null,
	          'Test pour intégration HTML/CSS/Javascript'
	        ),
	        _react2.default.createElement(
	          'span',
	          { className: 'links' },
	          ...
	          _react2.default.createElement(
	            'a',
	            { href: 'http://www.1000volts.fr/', target: '_blank' },
	            '1000 Volts'
	          )
	        )
	      );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ViewWithLeftMenu = __webpack_require__(221);
	
	var _ViewWithLeftMenu2 = _interopRequireDefault(_ViewWithLeftMenu);
	...
	var Home = (function (_React$Component) {
	  ...
	  _createClass(Home, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(_ViewWithLeftMenu2.default, { data: _home2.default });
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LeftNav = __webpack_require__(222);
	
	var _LeftNav2 = _interopRequireDefault(_LeftNav);
	
	var _Section = __webpack_require__(224);
	...
	var ViewWithLeftMenu = (function (_React$Component) {
	  _inherits(ViewWithLeftMenu, _React$Component);
	
	  function ViewWithLeftMenu() {
	    _classCallCheck(this, ViewWithLeftMenu);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ViewWithLeftMenu).apply(this, arguments));
	  }
	
	  _createClass(ViewWithLeftMenu, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'main', role: 'main' },
	        _react2.default.createElement(_LeftNav2.default, { section: this.props.data }),
	        _react2.default.createElement(_Section2.default, { section: this.props.data })
	      );
	    }
	  }]);
	
	  return ViewWithLeftMenu;
	})(_react2.default.Component);
	...
	ViewWithLeftMenu.propTypes = {
	  ...
	  data: _react2.default.PropTypes.shape({
	    ...
	    articles: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.object).isRequired
	  }).isRequired
	};
	exports.default = ViewWithLeftMenu;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _articleIdGenerator = __webpack_require__(223);
	
	var _articleIdGenerator2 = _interopRequireDefault(_articleIdGenerator);
	...
	var LeftNav = (function (_React$Component) {
	  ...
	  function LeftNav() {
	    ...
	    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(LeftNav)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {}, _this._generateArticleLinks = function (articles, prefixId) {
	      var links = articles.map(function (article, index) {
	        return _this._generateArticleLink(article, index, prefixId);
	      });
	      return _react2.default.createElement(
	        'ul',
	        null,
	    ...
	    }, _this._generateArticleLink = function (article, index, prefixId) {
	      if (article.type && article.type !== 'article') {
	        // it's not an article but a paragraph or figure
	        return null;
	      }
	
	      var id = (0, _articleIdGenerator2.default)(index, prefixId);
	      ...
	      var subLinks = [];
	      for (var i = 0; i < article.elements.length; i++) {
	        var subLink = _this._generateArticleLink(article.elements[i], i, id);
	        if (subLink) {
	      ...
	      return res;
	    }, _this._updateLeftMenuTop = function () {
	      ...
	      var top = Math.max(0, header.offsetHeight - scrollTop);
	  ...
	  _createClass(LeftNav, [{
	    ...
	    key: 'render',
	    value: function render() {
	      var links = this._generateArticleLinks(this.props.section.articles);
	      return _react2.default.createElement(
	        'nav',
	        { id: 'left-nav', style: this.state },
	        links
	      );
	    }
	  }]);
	...
	LeftNav.propTypes = {
	  // Section data
	  section: _react2.default.PropTypes.shape({
	    articles: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.object).isRequired
	  }).isRequired
	};
...
/***/ function(module, exports) {
	...
	exports.default = function (index, prefix) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Section = (function (_React$Component) {
	  ...
	  _createClass(Section, [{
	    key: 'render',
	    value: function render() {
	      var articles = this.props.section.articles.map(function (article, index) {
	        var key = (0, _articleIdGenerator2.default)(index);
	        return _react2.default.createElement(_Article2.default, { key: key, index: key, level: 1, article: article });
	      });
	      return _react2.default.createElement(
	        'section',
	        null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ArticleElement = __webpack_require__(226);
	...
	var Article = (function (_React$Component) {
	  ...
	  _createClass(Article, [{
	    ...
	    value: function render() {
	      ...
	      var title = _react2.default.createElement('h' + (level + 1), null, this.props.article.title);
	      var elements = this.props.article.elements.map(function (elt, index) {
	        var key = (0, _articleIdGenerator2.default)(index, _this2.props.index);
	        return _react2.default.createElement(_ArticleElement2.default, { key: key, index: key, level: level + 1, element: elt });
	      });
	...
	Article.propTypes = {
	  ...
	  article: _react2.default.PropTypes.shape({
	    title: _react2.default.PropTypes.string.isRequired,
	    elements: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.object)
	  }).isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Figure = __webpack_require__(227);
	
	var _Figure2 = _interopRequireDefault(_Figure);
	
	var _Paragraph = __webpack_require__(228);
	...
	var ArticleElement = (function (_React$Component) {
	  _inherits(ArticleElement, _React$Component);
	
	  function ArticleElement() {
	    _classCallCheck(this, ArticleElement);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(ArticleElement).apply(this, arguments));
	  }
	
	  _createClass(ArticleElement, [{
	    key: 'render',
	    value: function render() {
	      switch (this.props.element.type) {
	        case 'paragraph':
	          return _react2.default.createElement(_Paragraph2.default, { paragraph: this.props.element });
	        case 'figure':
	          return _react2.default.createElement(_Figure2.default, { figure: this.props.element });
	        case 'article':
	          return _react2.default.createElement(_Article2.default, { index: this.props.index, level: this.props.level, article: this.props.element });
	        default:
	...
	ArticleElement.propTypes = {
	  ...
	  element: _react2.default.PropTypes.shape({
	    type: _react2.default.PropTypes.oneOf(['paragraph', 'figure', 'article']).isRequired
	  }).isRequired
	};
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'figure',
	          null,
	          _react2.default.createElement('img', { src: this.props.figure.url, alt: this.props.figure.filename }),
	          _react2.default.createElement(
	            'figcaption',
	            null,
	            this.props.figure.caption
	          )
	        )
	      );
	    }
	...
	Figure.propTypes = {
	  figure: _react2.default.PropTypes.shape({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Paragraph = (function (_React$Component) {
	  ...
	  _createClass(Paragraph, [{
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement('p', { dangerouslySetInnerHTML: { __html: this.props.paragraph.text } });
	    }
	  }]);
	...
	Paragraph.propTypes = {
	  paragraph: _react2.default.PropTypes.shape({
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  articles: [{
	    ...
	    elements: [{
	      type: 'paragraph',
	      text: 'Proin fermentum tristique <strong>justo lobortis iaculis</strong>. Fusce augue felis, commodo et ipsum elementum, fringilla viverra sem. In sit amet sem suscipit, feugiat arcu ut, porttitor augue. Sed cursus malesuada imperdiet. Nunc cursus rutrum mauris ac laoreet. Maecenas a ex non metus lacinia consequat at eu metus.'
	    }]
	  }, {
	    title: 'Phasellus lobortis pellentesque vehicula',
	    elements: [{
	      type: 'paragraph',
	    ...
	    elements: [{
	      ...
	      type: 'article',
	      title: 'Proin fermentum tristique',
	      elements: [{
	        type: 'paragraph',
	        text: 'Morbi ornare, nisi sagittis sollicitudin rhoncus, quam purus cursus magna, non posuere leo turpis in erat. Mauris nisi neque, interdum at orci quis, venenatis viverra lorem. In sed orci tellus.'
	      }]
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "images/logo.dc86ef49353bdeaa59ef9174a0224ef1.png";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "images/favicon.35b980198786ad1c4ad93905bb3b823f.ico";

/***/ }
/******/ ])
});
;
//# sourceMappingURL=static.3de075ceb5fa40c9b873.js.map